...
* [pbcore](https://github.com/PacificBiosciences/pbbioconda) 
...
mkdir kineticsTools
cd kineticsTools
conda create --prefix=/Work/software/kineticsTools/v1.0.0 -c bioconda bax2bam=0.0.9 pbalign=0.3.2 pbcore=1.6.5 python=2.7
